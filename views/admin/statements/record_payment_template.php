...
<?php echo form_open(admin_url('statements/record_remittance'), ['id' => 'record_payment_form']); ?>
<div class="col-md-12 no-padding animated fadeIn">
    <div class="panel_s">
        <?php echo form_hidden('statementid', $statement->id); ?>
        <div class="panel-body">
            <h4 class="tw-my-0 tw-font-semibold">
                <?php echo _l('record_payment_for_statement'); ?> <?php echo format_statement_number($statement->id); ?>
            </h4>
            <hr class="hr-panel-separator" />
            <div class="row">
                <div class="col-md-6">
                    <?php
                    $amount       = $statement->total_left_to_pay;
                    $totalAllowed = 0;
                    ...
                    <div class="alert alert-info">
                        Allowed payment modes not found for this statement.<br />
                        Click <a
                            href="<?php echo admin_url('statements/statement/' . $statement->id . '?allowed_payment_modes=1'); ?>">here</a>
                        to edit the statement and allow payment modes.
                    </div>
                    <?php
                    } ?>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-gruoup">
                        ...
                        <textarea name="note" class="form-control" rows="8"
                            placeholder="<?php echo _l('statement_record_payment_note_placeholder'); ?>"
                            id="note"></textarea>
                    </div>
                </div>
                <div class="col-md-12 tw-mt-3">
                    <?php
                    $pr_template = is_email_template_active('statement-payment-recorded');
                    ...
                    <div class="checkbox checkbox-primary mtop15">
                        ...
                        <label for="do_not_send_email_template">
                            <?php
                            if ($pr_template) {
                                echo _l('do_not_send_statement_payment_email_template_contact');
                                if ($sms_trigger) {
                                    echo '/';
                                }
                            }
                            if ($sms_trigger) {
                                echo 'SMS' . ' ' . _l('statement_payment_recorded');
                            }
                            ?>
                        </label>
                    </div>
            ...
            <div class="mtop25 inline-block full-width">
                <h5 class="bold"><?php echo _l('statement_payments_received'); ?></h5>
        ...
        <div class="panel-footer text-right">
            <a href="#" class="btn btn-danger"
                onclick="init_statement(<?php echo $statement->id; ?>); return false;"><?php echo _l('cancel'); ?></a>
