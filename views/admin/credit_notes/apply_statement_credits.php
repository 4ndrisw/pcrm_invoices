...
<?php if ((credits_can_be_applied_to_statement($statement->status) && $credits_available > 0)) { ?>
<!-- Modal Apply Credits -->
<div class="modal fade apply-credits-from-statement" id="apply_credits" data-balance-due="<?php echo $statement->total_left_to_pay; ?>" tabindex="-1" role="dialog" aria-labelledby="modalLabelApplyCredits">
  <div class="modal-dialog modal-lg" role="document">
    <?php echo form_open(admin_url('statements/apply_credits/' . $statement->id), ['id' => 'apply_credits_form']); ?>
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="modalLabelApplyCredits">
            <?php echo format_statement_number($statement->id); ?> - <?php echo _l('apply_credits'); ?>
        </h4>
    </div>
                    ...
                    <tbody>
                     <tr>
                        ...
                        <td class="amount-to-credit">
                            <?php echo app_format_money(0, $statement->currency_name); ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="bold"><?php echo _l('balance_due'); ?>:</td>
                        <td class="statement-balance-due">
...
<script>
    ...
    init_currency(<?php echo $statement->currency; ?>);
    $(function(){
