...
if (!$CI->db->table_exists(db_prefix() . 'statements')) {
    $CI->db->query('CREATE TABLE `' . db_prefix() . "statements` (
		  `id` int NOT NULL,
		  ...
		  `show_shipping_on_statement` tinyint(1) NOT NULL DEFAULT '1',
    ...
    $CI->db->query('ALTER TABLE `' . db_prefix() . 'statements`
		  ADD PRIMARY KEY (`id`),
